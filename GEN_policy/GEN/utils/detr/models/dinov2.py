...
from utils.detr.util.grid_mask import GridMask
...
class DINOv2_Backbone(nn.Module):
    ...
    def forward(self, img_obs):
        '''
        Input:
            img_obs shape: (B, N, C, H, W)
        '''
        assert img_obs.ndim == 5
    ...
    def preprocess(self, imgs):      
        imgs = imgs / 255
        imgs = self.resize_op(imgs)
        imgs = self.norm_op(imgs)
